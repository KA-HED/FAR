...
public interface CompteRepository extends JpaRepository<Compte, Integer> {
	...
	@Query("from Compte fp  where  fp.profil.profilId=:id1 and fp.deleteDateTime is null order by fp.compteId DESC")
	public Page<Compte> getAllCompteByIdProfilPagePetitionnaire(@Param("id1") int id, Pageable page);
	...
	@Query("from Compte  where deleteDateTime is null and email=:email and password=:password ")
	public Compte SiExiste (String email, String password);
