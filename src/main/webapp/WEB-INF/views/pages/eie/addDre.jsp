                            ...
                            <div class="card">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-10 mt-4">
                                        <h3 class="ml6 float-right mb-1" style="color: #2196f3   !important">
                                                    ...
                                                    <div class="form-group" >
                                                        ...
                                                        <select id="region" class="custom-select" onchange="select_region(this.value)">
                                                            <c:forEach items="${regions}" var="reg">
                                                                <option value="${reg.id}" ${eie.region.id==reg.id?"selected":""}>${reg.nom_fr}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                </div>
        ...
        function addDRE(){
            ...
            $.ajax({
                ...
                success : function(response) {
                    document.location.href="/api/getDre/0/40";
