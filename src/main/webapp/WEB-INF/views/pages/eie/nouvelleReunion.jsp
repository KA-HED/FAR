                                ...
                                <div class="card">
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-10 mt-4" dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}">
                                            <h3 class="ml6 float-right" style="color: #2196f3   !important; margin-top: -5px !important;">
                                                    ...
                                                    <div class="col-md-6 col-sm-12 hidden">
                                                        <div class="form-group text-left">
                                                            ...
                                                            <select class="form-control" required name="examen" id="examen" ${dd}>
                                                                ...
                                                                <option ${reunion.examen.equals("deliberation")?"selected":""}  value="Déliberation"><spring:message code="label.Deliberation"/></option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <c:if test="${type=='AE'}">
