        ...
        <div class="content-wrapper">
                ...
                <div class="col-md-12 col-sm-12 col-lg-12" dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb ml-4">
                            ...
                            <c:set var="url_mini" value="/api/getEie/${typeS}/0/40/0"/>
            ...
            <section class="services-section mt-5" style="background-color: white">
                <div class="row grid-margin stretch-card cardstatistic" id="pagereload">
                    ...
                    <button style="background-color: #2196f3     !important;" class="tablinks btn" onclick="opendemande(event, '1')" id="defaultOpen">
                        1. <spring:message code="label.AttachementduRapportEP"/>
                    </button>
                    <button style="background-color: #2196f3     !important;"  class="tablinks btn mt-2 " ${disabledBtnTab} id="Btn2" onclick="opendemande(event, '2')">
                                    ...
                                    <%--<div class="form-group">--%>
                                        ...
                                        <%--<select  DISABLED name=""  id="id_region" required class="form-control select2" data-width="100%" multiple>--%>
                                            ...
                                            <%--<c:forEach items="${demande.regions}"  var="region">--%>
                                                ...
                                                <%--<option selected  value="${region.id}" >${region.nom_fr} || ${region.nom_ar} </option>--%>
                                            <%--</c:forEach>--%>
                                        <%--</select>--%>
                                        ...
                                        <c:forEach items="${demande.detailRegion.region}" var='reg' >
                                            <div class="col-md-6 mt-3 col-sm-12" >
                                                ...
                                                <div class="form-group text-left">
                                                    ...
                                                    <input  onchange="addDoc2(${demande.id_demande_information},'${reg.id}','doc${reg.id}')"  required accept=".doc,.docx,.pdf" type="file" class="form-control" name="doc${reg.id}" id="doc${reg.id}">
                                                </div>
...
<script>
    ...
    function addDoc2(id,id,idInput){
        var data = new FormData();
