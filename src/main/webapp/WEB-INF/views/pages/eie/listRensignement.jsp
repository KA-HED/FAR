        ...
        <div class="col-12" dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb ml-4">
                    ...
                    <li class="breadcrumb-item ${pageContext.response.locale=='ar'?'mr-5':''}"><a href="/api/Renseignement/11/0/40"><spring:message code="label.Renseignementprealables"/> </a></li>
                </ol>
            </nav>
        </div>
    </div>
    <div class="col-12 mt-3">
        ...
        <div class="row m-6">
            <div class="col-md-4 col-sm-4 mt-1">
                <a href="/api/Renseignement/11/0/40" class="btn btn-primary btn-block">
                    <spring:message code="label.Projetsnonassujettis"/>
                </a>
            </div>
            <div class="col-md-4 col-sm-4 mt-1">
                <a href="/api/Renseignement/12/0/40" class="btn btn-primary btn-block"><spring:message code="label.EIEaexaminerparCNEE"/></a>
            </div>
           <%-- <div class="col-md-4 col-sm-4 mt-1">
                <a href="/api/Renseignement/13/0/40" class="btn btn-primary btn-block"><spring:message code="label.EIEaexaminerparCRUI"/></a>
            </div>--%>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped mb-5">
                    ...
                    <tr>
                        ...
                        <th class="text-center"><spring:message code="label.ConsisitanceduProjet"/></th>
                       ...
                       <%-- <th class="text-center"><spring:message code="label.AvisProjet"/></th>--%>
                        ...
                        <c:if test="${notif[0].statut.id_statut_projet ==11 || notif[0].statut.id_statut_projet ==103}">
                    ...
                    <c:forEach items="${notif}" var="dmd">
                        <tr>
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${dmd.statut.id_statut_projet == 11}">
                                        En cours de traitement
                                    </c:when>
                                    <c:when test="${dmd.statut.id_statut_projet == 12}">
                                        <%--conforme--%>
                                        Projet assujettis-En attente du dossier de l’EIE
                                    </c:when>
                                    <c:when test="${dmd.statut.id_statut_projet == 13}">
                                        <%--Avis de projet--%>
                                    ...
                                    <%--${dmd.statut.id_statut_projet == 11?'En cours de traitement':dmd.statut.nom_fr}--%>
                            </td>
                            <td> ${dmd.email} </td>
                            <td> ${dmd.represantant} </td>
                            <td> ${dmd.tel} </td>
                            <td> ${dmd.fax} </td>
                            ...
                            <td>
                                <c:if test="${not empty dmd.consistance_proj}">
                                    <a class="btn btn-primary btn-sm" style="border-radius: 50%" href="${fn:replace(dmd.consistance_proj, "/assets/myFile/", "/dowload_uploaded/")}"> <i class="fa fa-download m-auto"></i> </a>
                                </c:if>
                                <c:if test="${empty dmd.consistance_proj}">
                                    -
                                </c:if>
                            </td>
                            <td>
                            ...
                            <c:if test="${dmd.statut.id_statut_projet == 11 || dmd.statut.id_statut_projet == 103}">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                        <div class="col-12 mt-3" id="msg_comment" >
                                    ...
                                    <div class="modal-footer">
                                        <button  onclick="close_modal(this)" type="button" class="btn btn-danger-2" data-dismiss="modal"><spring:message code="label.Annuler"/></button>
...
<script>
    ...
    function saveAssujettissement(id_decl){
        ...
        $.ajax({
            ...
            success : function(response) {
                ...
                window.location.href="/api/Renseignement/11/0/40";
            },
            error : function() {
            }
        });
    ...
    function listAlimentation(page, size, statut) {
        window.location.href = '/api/Renseignement/' + statut + '/' + page + '/40';
    }
