                                                    ...
                                                    <c:when test="${type=='AE'}">
                                                        <div class="col-md-6 col-sm-12  ${demande.statut.id_statut_projet==74 || demande.statut.id_statut_projet==81 || demande.statut.id_statut_projet==2?'d-none':''}">
                                                            ...
                                                            <select class="custom-select mb-3" name="periode_send_rapport" id="periode_send_rapport" ${dd}>
                                                                <option value="0" selected="selected"><spring:message code="label.Choisirrr"/> </option>
                                            ...
                                            <div class="row m-0 p-0 mt-3">
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group text-left">
                                                        ...
                                                        <select disabled class="form-control select2" multiple onchange="addCategorieToDemande(this,'${demande.id_demande_information}')" style="width: 100% !important" ${dd}>
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group text-left">
                                                        ...
                                                        <select disabled name="souscategorie_id" id="soucat"  class="form-control select2" multiple onchange="addSousCategorieToDemande(this,'${demande.id_demande_information}')" style="width: 100% !important" ${dd}>
