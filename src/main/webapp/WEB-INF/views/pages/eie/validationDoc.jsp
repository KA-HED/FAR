            ...
            <div class="col-md-12 col-sm-12 col-lg-12" >
                <div class="col-12" dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}">
                    ...
                    <ol class="breadcrumb ml-4">
                        ...
                        <c:set var="url_mini" value="/api/getEie/${type}/0/40/0"/>
                            ...
                            <c:choose>
                                <c:when test="${type!='AE'}">
                                    <div class="col-xl-2 col-lg-4 p-1">
                                        <button class="btn btn-primary btn-block " id="valider" onclick="changer_statu('${demande.id_demande_information}','58','${type}')" ><c:if test="${type.equals('EE')}"><spring:message code="label.Valider"/></c:if><c:if test="${type.equals('NT')}"><spring:message code="label.Valider"/></c:if></button>
                                    </div>

                                    <div class="col-xl-2 col-lg-4 p-1">
                                        <button class="btn btn-secondary btn-block" id="non_conforme" onclick="changer_statu('${demande.id_demande_information}','59','${type}')" style="background: #f95f5f;"><c:if test="${type.equals('EE')}"><spring:message code="label.Incomplet"/></c:if><c:if test="${type.equals('NT')}"><spring:message code="label.Incomplet"/></c:if></button>
                                    </div>
                                ...
                                <c:otherwise>
                                    <div class="col-xl-2 col-lg-4 p-1">
                                        <button class="btn btn-primary btn-block "  onclick="changer_statu('${demande.id_demande_information}','73','${type}')" ><spring:message code="label.Recevable"/> </button>
                                    </div>
                                    <div class=" col-xl-2 col-lg-4 p-1">
                                        <button class="btn btn-secondary btn-block text-dark" onclick="changer_statu('${demande.id_demande_information}','59','${type}')" style="background: #f95f5f;"><spring:message code="label.NonRecevable"/> </button>
                                    </div>
                                </c:otherwise>
                            </c:choose>
                                ...
                                <div class="col-6 border p-2">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-4 col-sm-12">
                                            <a href="/api/getEie/AE/0/40/0" class="btn btn-primary btn-block">
                                        ...
                                        <div class="card">
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-10 mt-4" dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}">
                                                    <h3 class="ml6 float-right" style="color: #2196f3   !important; margin-top: -5px">
                                                    ...
                                                    <form style="text-align: ${pageContext.response.locale=='ar'?'right':'left'}" class="form-horizontal mt-3" id="deposestatut" name="deposestatut" method="post">
                                                        ...
                                                        <div class="row m-0 p-0 mt-5 pb-4 justify-content-end">
                                                            ...
                                                            <div class="col-xl-2 col-lg-4 p-1">
                                                                <a type="button" class="btn btn-primary btn-block" href="/api/getEie/NT/0/40/0" ><spring:message code="label.Enregistrer"/> </a>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                ...
                success : function(response) {
                    if(type1=="AE" && statut==59){
                       ...
                       // window.location.href="/api/editdemande/"+response+"/all/"+type1;
                        window.location.href="/api/getEie/"+type1+"/0/40/0";
                    }
