						...
						<div class="col-12" dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}">
							...
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb ml-4">
									...
									<li class="breadcrumb-item ${pageContext.response.locale!='ar'?'':'mr-5'}">><a href="/api/getDre/0/40"><spring:message code="label.Etudedimpactenvirementalee" /></a></li>
								</ol>
							</nav>
           				 </div>
...
function listAlimentation(page, size) {
	   ...
	   window.location.href='/api/getDre/'+page+'/40';
