                                            ...
                                            <div class="row m-0 pt-5">
                                                ...
                                                <div class="col-6">
                                                    <a class="button text-white bgMyColor float-right"
                                                       href="/ECGSM/formToAddCompte_Rendu/0"><span>Ajouter </span>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <td class="text-center">
                                                        <ul class="list-inline m-0">
                                                            <li class="list-inline-item text-center">
                                                                <a href="/ECGSM/formToAddCompte_Rendu/${f.crId}"
                                                                   class="btn"
                                                            ...
                                                            <li class="list-inline-item">
                                                                <button onclick="deleteCompte_Rendu(${f.crId})"
                                                                        class="btn"
                                    ...
                                    <%--<c:choose>--%>
                                        <%--<c:when test="${not empty listF}">--%>
                                            <%--<div class="pagination pagination-lg justify-content-center mt-3" dir="ltr">--%>
                                                ...
                                                <%--<a style="background-color: #184a00bd     ;text-align: center;background-size: 100% 100%" onclick="getParamCompte_Rendu(0, ${type})" class="pageStyle"><i class="mdi mdi-arrow-collapse-left m-0"></i></a>--%>
                                                <%--<a  style="background-color: #184a00bd   !important;" onclick="getParamCompte_Rendu(${page_db}, ${type})" class="pageStyle">&laquo;</a>--%>
                                                ...
                                                <%--<c:if test="${totalPage>0}">--%>
                                                    <%--<c:forEach begin="${page}" end="${page+toAdd}" var="c">--%>
                                                        <%--<a style="background-color: #184a00bd   !important; ${page+toAdd}" onclick="getParamCompte_Rendu(${c}, ${type})"  ${c==number ? 'class=" pageStyle1 active "' : 'class=" pageStyle"'}>${c+1}</a>--%>
                                                    <%--</c:forEach>--%>
                                                <%--</c:if>--%>
                                                ...
                                                <%--<a style="background-color: #184a00bd   !important;" onclick="getParamCompte_Rendu(${page_end}, ${type})" class="pageStyle">&raquo;</a>--%>
                                                <%--<a style="background-color: #184a00bd     ;text-align: center;background-size: 100% 100%" onclick="getParamCompte_Rendu(${totalPage-1}, ${type})" class="pageStyle"><i class="mdi mdi-arrow-collapse-right m-0"></i></a>--%>
...
<script>
    ...
    function deleteCompte_Rendu(id){

        $.ajax({
            type : "POST",
            url :"/api/param/deleteCompte_Rendu",
            data:{
                "id":id
            },
