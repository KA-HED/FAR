                                    ...
                                    <div class="col-10 mt-4"  >
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group" <%--dir= "rtl"--%>>
                                                    <label>الجواب</label>
                                                    <textarea class="form-control" rows="4" name="reponse_fr">${question.reponses.size()>0?question.reponses.get(0).description:""}</textarea>
                                                </div>
                                                <div class="form-group" >
                                                    <label><spring:message code="label.reponse"/></label>
                                                    <textarea class="form-control" rows="4" name="reponse">${question.reponses.size()>0?question.reponses.get(0).description_fr:""}</textarea>
                                                </div>
