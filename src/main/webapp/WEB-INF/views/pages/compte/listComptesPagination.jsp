...
<div class="row">
    ...
    <div class="col-md-10  col-sm-12 col-lg-10 btn-warnings " style="border: 1px #80808024 solid ;">
        <div class="col-lg-6 col-sm-4 col-md-4 divMarges"><spring:message
                code="label.Email"/></div>
        <div class="col-lg-4 col-sm-4 col-md-4 divMarges"><spring:message
                code="label.Nom"/></div>
    ...
    <c:if test="${cpt.compteId!=user.compteId}">
        <div class="row">
            ...
            <div class="col-md-10 col-sm-12 col-lg-10 btn-warningBody padBot  "
                ...
                <div class="col-lg-6 col-sm-4 col-md-4 bordRight">${cpt.email }</div>
                <div class="col-lg-4 col-sm-4 col-md-4 bordRight">${cpt.nom }</div>
