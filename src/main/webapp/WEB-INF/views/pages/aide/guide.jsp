        ...
        <div class="col-md-4">
            <div class="box" onclick="OpenRetour('autorisation','ZF')">
                <div class="our-services settings">
                    <div class="icon"> <img src="https://i.imgur.com/40NKPrhO.png"> </div>
                    <h4>ZF</h4>
            ...
            <div class="col-md-6 ">
                <div class="row border-success border rounded rou  p-2 pl-4 pr-4 m-1">
                    ...
                    <div class="col-12  p-0 m-0">
                        <div class="row justify-content-end border-top border-success">
                            <div class="col-md-5 btn-sm-12 mt-3 p-0">
                                <a href="/api/getListeAutorisation/ZF/0/40/0" class="btn  btn-sms4"> <span class="fa fa-plus-circle"></span> <spring:message code='label.Detail'/></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="row border-success border rounded rou  p-2 pl-4 pr-4 m-1">
                    ...
                    <div class="col-12 p-0 m-0">
                        <div class="row justify-content-end border-top border-success">
                            <div class="col-md-5 btn-sm-12 mt-3 p-0">
                                <a  href="/api/getListeAutorisation/ET/0/40/0" class="btn  btn-sms4"> <span class="fa fa-plus-circle"></span> <spring:message code='label.Detail'/> </a>
                            </div>
                        </div>
                    </div>
                </div>
