                ...
                <div class="row p-3" style="border: 2px solid #eaeaea; border-radius: 4px;" dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}">
                        <div class="col-md-8 col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Tapez la numéro de demande complet" id="numDemande" name="numDemande" />
                            </div>
                        </div>
                ...
                <table
                    ...
                    <c:forEach items="${notif}" var="aud">
                        <tr>
                            ...
                            <td>
<%--                                <fmt:parseDate value="${aud.dateAction}" pattern="yyyy-MM-dd'T'HH:mm" var="parsedDateTime" type="both" />--%>
