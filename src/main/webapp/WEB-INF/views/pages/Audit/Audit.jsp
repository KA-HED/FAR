...
<div class="container-fluid page-body-wrapper"
	...
	<div class="main-panel"
		style="background: white !important; margin-top: 145px">
		<div class="col-12 p-4"
			dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb ml-4">
					<li class="breadcrumb-item"
						style="${pageContext.response.locale=='ar'?'right:3px !important':'left:-10px !important'};top: 14px !important;"><a
						href="/api/getMenu"><i class="fa fa-home pt-3 Pl-2"></i></a></li>
					<li class="breadcrumb-item active"
						style="${pageContext.response.locale!='ar'?'':'margin-right:4rem !important'}"
						aria-current="page"><spring:message code="label.Auditsysteme" />
					</li>
				</ol>
			</nav>
			<div class="row" style="display: flex; padding: 26px;">
				<form action="/api/AuditSearch/0/6" method="get">
					<div class="row p-3"
						style="border: 2px solid #eaeaea; border-radius: 4px;"
						dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}">
						<div class="col-md-3 col-sm-12">
							<div class="form-group">
								<label><spring:message code='label.Utilisateur' /></label> <select
									class="form-control" name="id_user">
									<option selected="" value="0"><spring:message
											code='label.Choisir' /></option>
						...
						<div class="col-md-3 col-sm-12">
							<div class="form-group">
								<label><spring:message code='label.Date' /></label> <input
									type="date" name="date" class="form-control">
							</div>
						</div>
						<div class="col-md-4 col-sm-12">
							<div class="form-group">
								<label><spring:message code='label.Operation' /></label> <select
									class="form-control" name="action">
									<option selected value="0"><spring:message
											code='label.Choisir' /></option>
									<option value="ajouter"><spring:message
											code='label.Ajouter' /></option>
									<option value="modifier"><spring:message
											code='label.Modifier' /></option>
									<option value="supprimer"><spring:message
											code='label.Supprimer' /></option>
								</select>
							</div>
						</div>
						<div class="col-md-2 col-sm-12 mt-4">
							...
							<button class="btn btn-success" type="submit">
								<spring:message code='label.rechercher' />
							</button>
			...
			<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12"
				...
				<table
					...
					<thead class="bg-vert">
						<tr>
							<th class="text-center text-white"><spring:message
									code='label.Utilisateur' /></th>
							<th class="text-center text-white"><spring:message
						...
						<c:forEach items="${notif}" var="aud">
							<tr>
								...
								<td style="display: flex;">
									<!-- Modal -->
									<div style="margin-top: 123px;" class="modal fade"
										id="idModal${aud.auditId }" tabindex="-1" role="dialog"
										aria-labelledby="exampleModalLabel" aria-hidden="true">
										<div class="modal-dialog  modal-lg " role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="exampleModalLabel">
														<spring:message code='label.DetailsOperation' />
													</h5>
													<button type="button" class="close"
														onclick="hideModal(${aud.auditId })" aria-label="Close">
												...
												<div class="modal-body col-md-12"
													...
													<table id="oldData-${aud.auditId }"
														class="col-md-6 table table-bordered">
				...
				<c:choose>
					...
					<c:otherwise>
						...
						<h4 style="color: black; text-align: center">
							<spring:message code='label.Ilnyaaucuneenregistrement' />
						</h4>
					</c:otherwise>
				</c:choose>
			</div>
