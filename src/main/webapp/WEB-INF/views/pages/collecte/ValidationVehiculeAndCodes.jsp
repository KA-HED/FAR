                        ...
                        <div class="col-lg-8 col-md-10 col-sm-12 grid-margin stretch-card " >
                            ...
                            <div class="card">
                                <div class="row justify-content-center">
                                    ...
                                    <input type="hidden" value="${type}" id="typee">
                                    <h5 class="mt-3 myH3" style="float:right;color:black"><spring:message code="label.Validerdocument"/></h5>
                                    <div class="col-12 mt-4" >
                                        <div class="row p-3" id="document">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row justify-content-end  mb-4" style="margin:14px;">
                                                    <div class="col-md-4 ">
                                                        <a type="button" class="btn btn-primary mt-1 col-md-6" onclick="showCodes()"><spring:message code="label.Suivant"/><i class="fa fa-arrow-right ml-2"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row p-3" id="listCode" style="display: none;" dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}">
                                            <section class="col-md-12">
                                                ...
                                                <div class="row  justify-content-center float-right m-4" style="margin:14px;">
                                                    <a type="button" class="btn btn-secondary float-right btn-lg" onclick="showDocument()" style="background: #f95f5f;"><i class="fa fa-arrow-left mr-2"></i> <spring:message code="label.Precedent"/></a>
                                                    <c:if test="${cpt==0}">
                                                        <a type="button" class="btn btn-primary float-right mx-2  btn-lg" onclick="showAvisCommision()"><spring:message code="label.Suivant"/><i class="fa fa-arrow-right ml-2"></i></a>
                                                    </c:if>
                                                    <c:if test="${cpt!=0}">
                                                        <a type="button" class="btn btn-primary float-right btn-lg mx-2" onclick="showVehicule()"><spring:message code="label.Suivant"/> <i class="fa fa-arrow-right ml-2"></i></a>
                                                    </c:if>
                                                </div>
                                            </section>
                                        </div>
                                        <div  class="row justify-content-center p-3" dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}" id="Vehicule" style="display: none">
                                                            ...
                                                            <c:forEach items="${collecte.vehicules}" var="v">
                                                                <c:if test="${!v.valid.equals('oui')}">
                                                                    <tr id="tr${v.id_vehicule}">
                                                                        <td style="direction: rtl"> ${v.num_mat_id_prefect} - ${v.num_mat_enrg_auto}
                                                                            - ${v.num_mat_enrg_voit}</td>
                                                                        <td>${v.num_chassis}</td>
                                            ...
                                            <div class="row  justify-content-center float-right m-4" style="margin:14px;">
                                                ...
                                                <a type="button" class="btn btn-primary float-right btn-lg mx-2" onclick="showAvisCommision()"><spring:message code="label.Suivant"/> <i class="fa fa-arrow-right ml-2"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row justify-content-center p-3" id="avisComission" style="display: none">
                                        <div class="col-12">
                                            <%-- <div class="row mt-5">
                                                <div class="form-group" style="width: 100%;">
                                                    <div class="form-group text-left" id="block_file">
                                                        <label><spring:message code="label.compteRendu"/></label>
                                                ...
                                                <section class=" col-12 m-0 p-0">
                                                    <div class="form-group dt " style="${pageContext.response.locale=='ar'?'text-align:right':'text-align-left'}">
                                                        ...
                                                        <select required id="etat_st" class="custom-select " onclick="testCodes(this.value)" ${dd}>
                                                            ...
                                                            <%--                                                                <option value="104">Acceptable</option>--%>
                                            ...
                                            <%-- <div class="row mt-3 justify-content-start" id="docImp" style="display: none">
                                                     <section class=" col-12 m-0 p-0" style="width:500px">
                                                         <div class="form-group dt " style="${pageContext.response.locale=='ar'?'text-align:right':'text-align-left'}">
                                                             <label> <spring:message code="label.PiecesJointes"/> </label>
                                                             <select required id="docImport" class="custom-select">
                                                                 <option value="0"><spring:message code="label.Choisir"/></option>
                                                                 <c:forEach items="${doc}" var="dc">
                                                                     <option value="${dc.docImport.id_docImport}">${dc.docImport.nom_fr}</option>
                                                                 </c:forEach>
                                                             </select>
                                                         </div>
                                                     </section>
    ...
    <script>
        ...
        function addEtatCollecte(id,etat){
            ...
            $.ajax({
                ...
                success : function(response) {
                    window.location="//api/recap_collecte/"+id;
                },
                error : function(response) {
        ...
        function addEtat(id,etat){
            ...
            $.ajax({
                ...
                success : function(response) {
                    window.location="/api/getListeCollecte/0/40/0";
                },
                error : function(response) {
                    alert(' ajout non effectué');
                }
        ...
        function saveEtat(){
            ...
            /*var pv = document.getElementById("pv_file").files.length;
                ...
                if (pv===0) {
                    swal("Avertissement", "Fichier obligatoire", "warning");
                    return false;
                }*/
