                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" dir="${pageContext.response.locale=="ar"?'ltr':''}" disabled value="${collecte.demandeurAdresse}" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" disabled value="${collecte.demandeurTel}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
