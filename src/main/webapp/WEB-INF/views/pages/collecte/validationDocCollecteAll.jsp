        ...
        <div class="row mt-5 pt-5">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb ml-4">
                    ...
                    <li class="breadcrumb-item"><a href="/api/getListeCollecte/0/40/0"><spring:message code="label.CollecteETTransportDesDEchets"/></a></li>
                        ...
                        <form name="doc" id="doc_tmp">
                            <table class="table table-striped table-hover table-bordered tw_tab">
                                ...
                                <c:forEach items="${doc}" var="dc">
                                    <c:if test="${!dc.nom_ar.equals('siiii')}">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-check form-switch">
                                                    <input id="check${dc.id_listDocNotif }"  ${dc.nom_ar.equals('oui')?'checked':'' }  data-choose="${dc.id_listDocNotif }" class="form-check-input my_check" type="checkbox" id="flexSwitchCheckDefault">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="row">
                                                    <div class="col" >
                                                        ...
                                                        <textarea  readonly rows="2"class="form-control mb-0" id="id${dc.id_listDocNotif }" >${dc.nom_fr }</textarea>
                                                    </div>
                                                        <%--<div class="col-auto">
