    ...
    <div class="col-12">
        <nav aria-label="breadcrumb ml-4" dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}" >
            <ol class="breadcrumb ml-4" style="margin-top: -24px !important;">
                ...
                <li class="breadcrumb-item active" style="${pageContext.response.locale!='ar'?'':'margin-right:4rem !important'}" aria-current="page"><a href="/api/getListeCollecte/0/40/0"><spring:message code="label.CollecteETTransportDesDEchets"/></a></li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="row justify-content-center pl-3 pr-3 mt-4" style="${pageContext.response.locale=='ar'?'text-align:right;':'text-align:left;'}">
    <div class="col-12" dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}">
        <div class="jumbotron p-3">
            Demande numéro : <span class="h4 font-weight-bold" style="color: #3b5998">   ${collecte.num_demande}</span><span>
        </span>
        </div>
        <div class="jumbotron p-3">
                                                                ...
                                                                <div class="col-12 table-responsive">
                                                                    <table id="tab2"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <th style="min-width: 350px"><spring:message
                                                                        ...
                                                                        <tbody>
                                                                        <c:choose>
                                                                            <c:when test="${(not empty vehiculesLIST)}">
                                                                                <c:forEach items="${vehiculesLIST}" var="v">
                                                                                    <tr id="tr${v.id_vehicule}">
                                                                                            <td style="direction: rtl" >
                                                                                                    ${v.num_mat_id_prefect} - ${v.num_mat_enrg_auto}
                                                                                                - ${v.num_mat_enrg_voit}
                                                                                            </td>
                                                                                            <td>${v.num_chassis}</td>
                                                                        ...
                                                                        -->
                                                                                        ...
                                                                                        <textarea rows="2" disabled
                                                                                                  class="form-control mb-0">${v.commantaire}</textarea>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </c:if>
                                                                                            </td>
                                                                            ...
                                                                            <c:otherwise>
                                                                                <tr>
                                                                                    <td colspan="7" class="bg-primary text-center">
                                                                                        <spring:message
                                                                                                code="label.Aucunvehiculenestenregistre"/></td>
                                                                                </tr>
                                                                            </c:otherwise>
                                                                        </c:choose>
                                                                        </tbody>
                                                            ...
                                                            <div class="col-lg-12 col-md-12" id="zone_tableau">
                                                                ...
                                                                <table class="table table-striped" data-page-length="15">
                                                                    ...
                                                                    <c:forEach items="${codeList}" var="code_colle">
                                                                        ...
                                                                        <c:forEach items="${code}" var="cc">
                                                                            <c:if test="${code_colle.id_code != cc.id_code}">
