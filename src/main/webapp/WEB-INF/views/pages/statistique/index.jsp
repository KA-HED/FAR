            ...
            <c:if test="${auto.equals('auto')}">
                <div class="col-md-3 col-sm-6">
                    <div class="card-counter primary">
                        ...
                        <span class="count-numbers">${nbr_ZF_D} / ${nbr_ZFSigne_D}</span>
                        <h6 class="count-name"><spring:message code='label.Importationdesdechetsdunezonnefranche'/> <spring:message code='label.dangereux'/></h6>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="card-counter primary">
                        <i class="fa fa-recycle"></i>
                        <span class="count-numbers">${nbr_ZF_ND} / ${nbr_ZFSigne_ND}</span>
                        <h6 class="count-name"><spring:message code='label.Importationdesdechetsdunezonnefranche'/> <spring:message code='label.nondangereux'/></h6>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="card-counter danger">
                        <i class="fa fa-recycle"></i>
                        <span class="count-numbers">${nbr_ET} / ${nbr_ETSigne}</span>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="card-counter success">
                        <i class="fa fa-recycle"></i>
                        <span class="count-numbers">${nbr_XD} / ${nbr_XDSigne}</span>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="card-counter info">
                        <i class="fa fa-recycle"></i>
                        <span class="count-numbers">${nbr_TR} / ${nbr_TRSigne}</span>
                ...
                <div class="col-md-3 col-sm-6" style="margin-top: 25px">
                    <div class="card-counter primary1">
                        ...
                        <span class="count-numbers">${nbr_CT} / ${nbr_CTSigne}</span>
                ...
                <div class="col-md-3 col-sm-6" style="margin-top: 25px">
                    <div class="card-counter danger1">
                        ...
                        <span class="count-numbers">${nbr_INST} / ${nbr_INSTSigne}</span>
