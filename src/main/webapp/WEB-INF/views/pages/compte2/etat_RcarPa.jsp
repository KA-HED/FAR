...
<head>
    <meta charset="UTF-8">
    <title>COTISATION PATRONALE AU RCAR </title>
    ...
    <div id="mainArea">
            ...
            <div class="sectionContent" style=" font-size: 13px;">
                <div class="sectionTitle" style="width: 100%;font-size: 16px;text-align: center;font-weight: bold;">
                    <h2>COTISATION PATRONALE AU RCAR DU MOIS ${mois_l}/${annee}</h2>
                </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-12">
                        ...
                        <table >
                            ...
                            <tr style="background:#00b060;">
                                ...
                                <th scope="col">RCAR.S</th>
                                <th scope="col">C/RCAR.S</th>
                                <th scope="col">RCAR.P</th>
                                <th scope="col">C/RCAR.P</th>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach items="${agentSalaire}" var="dre">
                                <tr>
                                    ...
                                    <td>${dre.rcar_Regime_general*2}</td>
                                    <td>${dre.rcar_Regime_complementaire}</td>
                            ...
                            <tr>
                                ...
                                <td> ${Math.round((ar[1]*2)*100)/100}</td>
                                <td> ${Math.round(ar[2]*100)/100}</td>
