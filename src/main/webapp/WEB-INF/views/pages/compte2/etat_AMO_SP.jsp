...
<head>
    <meta charset="UTF-8">
    <title>Etat CNOPS (AMO) Salariale/Patronale</title>
    ...
    <div id="mainArea">
            ...
            <div class="sectionContent" style=" font-size: 13px;">
                <div class="sectionTitle" style="width: 100%;font-size: 16px;text-align: center;font-weight: bold;">
                    <h3>Etat détaillé des versements concernant l'Assurance Maladie Obligatoire de base (AMO)</br>
                        Effectués au profit de la Caisse Nationale des Organismes de Prévoyance Sociale</br>
                        Au titre du mois ${mois_l}/${annee}</h3>
                </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-12">
                        ...
                        <table >
                            ...
                            <tr style="background:#00b060;">
                                ...
                                <th scope="col">Cotisation salariale</th>
                                <th scope="col">Cotisation patronale</th>
                                <th scope="col">Total des cotisations</th>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach items="${agentSalaire}" var="dre">
                                <tr>
                                    ...
                                    <td>${dre.assurance_Maladie_Obligatoire}</td>
                                    <td>${dre.assurance_Maladie_Obligatoire*2}</td>
                            ...
                            <tr>
                                ...
                                <td> ${Math.round(ar[5]*100)/100}</td>
                                <td> ${Math.round((ar[5]*2)*100)/100}</td>
