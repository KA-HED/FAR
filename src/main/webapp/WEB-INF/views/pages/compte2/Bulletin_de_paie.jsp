    ...
    <div id="mainArea">
            ...
            <div class="sectionContent" style=" font-size: 13px;">
                <div class="sectionTitle" style="width: 100%;font-size: 16px;text-align: center;font-weight: bold;">
                    <h1>Bulletin de paie mois de ${mois_l}/${annee}</h1>
                </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-12">
                        ...
                        <table >
                            ...
                            <tr style="background:#00b060;">
                                ...
                                <th scope="col">RCAR RG</th>
                                <th scope="col">RCAR RC</th>
                                <th scope="col">IR</th>
                                <th scope="col">AMO</th>
                                <th scope="col">MGPAP S.M</th>
                                <th scope="col">MGPAP C.C.D</th>
                            ...
                            <c:forEach items="${agentSalaire}" var="dre">
                                <tr>
                                    ...
                                    <td>${dre.rcar_Regime_general}</td>
                                    <td>${dre.rcar_Regime_complementaire}</td>
                                    <td>${dre.ir_net}</td>
                            ...
                            <tr>
                                ...
                                <td> ${Math.round(ar[3]*100)/100}</td>
                                <td> ${Math.round(ar[4]*100)/100}</td>
