    ...
    <div id="mainArea">
            ...
            <div class="sectionContent" style=" font-size: 13px;">
                <div class="sectionTitle" style="width: 100%;font-size: 16px;text-align: center;font-weight: bold;">
                    <h2>Etat détaillé des Prélèvements au titre de la Mutuelle SM + CCD (Personnel Actif)
                        Au titre du mois ${mois_l}/${annee}</h2>
                </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-12">
                        ...
                        <table >
                            ...
                            <tr style="background:#00b060;">
                                ...
                                <th scope="col">Traitement Brut impos TBI </th>
                                <th scope="col">Part patronale</th>
                                <th scope="col">Cot AMO 2,5% du TBI</th>
                                <th scope="col">Cot SM 1,5% du TBI</th>
                                <th scope="col">Cot CCD 1% du TBI</th>
                            ...
                            <c:forEach items="${agentSalaire}" var="dre">
                                <tr>
                                    ...
                                    <td>${dre.assurance_Maladie_Obligatoire}</td>
                                    <td>${dre.assurance_Maladie_Obligatoire}</td>
                                    <td>${dre.mgpap_S_M}</td>
                                    <td>${dre.mgpap_C_C_D}</td>
                                    <td>${dre.salaire_net}</td>
                                </tr>
                            </c:forEach>
                            ...
                            <tr>
                                ...
                                <%--<td> ${Math.round(ar[1]*100)/100}</td>--%>
                                <td> ${Math.round(ar[2]*100)/100}</td>
                                <td> ${Math.round(ar[2]*100)/100}</td>
                                <td> ${Math.round(ar[5]*100)/100}</td>
                                <td> ${Math.round(ar[6]*100)/100}</td>
                                <td> ${Math.round(ar[7]*100)/100}</td>
