                ...
                <div class="col-md-8 mt-5 col-sm-12 grid-margin">
                    ...
                    <div class="card" >
                            ...
                            <div class="col-10 mt-4" dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                         <div class="form-group">
                                              <label>Login</label>
                                              <input autocomplete="false" required type="text" id="email" name="email"  value="${Compte.email}" class="form-control" onchange="checkEmaill(this.value)">
                                          ...
                                          <div class="row region1 ${Compte.typeregion.equals('2')?'hidden':''}">
                                              <div class="col-12" dir="ltr">
                                                  <div class="form-group text-left" id="region_form_group">
                                                      ...
                                                      <select id="id" class="custom-select" style="height: 40px">
                                                          <option  selected value="0"><spring:message code="label.Choisir" /></option>
                                                          <c:forEach items="${regionss }" var="r">
                                                              <option ${Compte.region.id==r.id?"selected":"" } value="${r.id}">${r[lng]}</option>
                                                          </c:forEach>
                                                      </select>
                                                  </div>
                        ...
                        <div class="row justify-content-center mb-4" style="margin:14px;">
                            ...
                            <a type="button" class="btn btn-danger-2  col-md-5 m-1" href="/api/getAccount5/0/40/0"><span style="color: white"> <spring:message code="label.Annuler"/></span></a>
                        </div>
                    </div>
                </div>
            </div>
             ...
             if ($("form[name='compteForm']").valid()) {
                 ...
                 $.ajax({
                     ...
                     success: function (response) {
                         window.location.href = '/api/getAccount5/0/40/0'
                     },
