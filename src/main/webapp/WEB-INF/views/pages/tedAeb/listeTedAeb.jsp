                                        ...
                                        <div class="col-lg-12 pr-0">
                                            <div class="row m-0 pt-5">
                                                <div class="col-6 pl-0">
                                                    <h4 class="ml6">
                                                        <span>Ordre de mutation </span>
                                                    </h4>
                                                </div>
                                                <div class="col-6">
                                                    <a class="button text-white bgMyColor float-right"
                                                       href="/TedAeb/formToAddTedAeb/0"><span>Ajouter</span>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="ta" class="container__inner content__description" style="padding-bottom: 10px;   min-height: 201px;">
                                        ...
                                        <table class="table table-bordered table-checkable  tablee table-hover">
                                            ...
                                            <tbody id="myTable">
                                                ...
                                                <tr id="tr-${f.tedAebId}">
                                                    <td>${f.unitesCriblees.nomAbrege}</td>
                                                    <td class="text-center">
                                                        <ul class="list-inline m-0">
                                                            <li class="list-inline-item text-center">
                                                                <a href="/TedAeb/formToAddTedAeb/${f.tedAebId}"
                                                                   class="btn"
                                                            ...
                                                            <li class="list-inline-item">
                                                                <button onclick="deleteCompte(${f.tedAebId})"
                                                                        class="btn"
