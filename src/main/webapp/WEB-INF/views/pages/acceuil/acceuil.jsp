                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6 col-ms-12 pl-1 pr-1">
                        <div class="row border-secondary border rounded rou  p-2 pl-4 pr-4 m-1">
                            ...
                            <div class="col-12 p-0 m-0">
                                <div class="row justify-content-center border-top border-secondary">
                                    <div class="col-md-5 btn-sm-12 mt-3 p-0">
                                        <a  href="/api/getEie/NT/0/40/0" class="btn  btn-sms4"> <span class="fa fa-plus-circle"></span> <spring:message code='label.Detail'/> </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6 col-ms-12 pl-1 pr-1">
                        <div class="row border-secondary border rounded rou  p-2 pl-4 pr-4 m-1">
                            ...
                            <div class="col-12 p-0 m-0">
                                <div class="row justify-content-center border-top border-secondary">
                                    <div class="col-md-5 btn-sm-12 mt-3 p-0">
                                        <a  href="/api/getEie/AE/0/40/0" class="btn  btn-sms4"> <span class="fa fa-plus-circle"></span> <spring:message code='label.Detail'/></a>
                                    </div>
                                </div>
                            </div>
                        </div>
