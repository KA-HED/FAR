                    ...
                    <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-12 mt-4">
                                        <div class="form-group text-left">
                                            ...
                                            <select onchange="param_EIE_hide_Class(this)" id="typeaut" name="typeaut"
                                ...
                                <div class="row" dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}">
                                    ...
                                    <c:if test="${not empty doc.uri}">
                                        ...
                                        <div class="col-2 mt-4">
                                            <a href="${fn:replace(doc.uri,"/assets/myFile/","/dowload_uploaded/")}"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group text-left">
                                            ...
                                            <textarea dir="ltr" id="desc" rows="6" class="form-control"
                                                      placeholder="Description du fichier">${doc.description}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row  mb-4" style="margin:14px;">
                            ...
                            <a class="btn btn btn-danger-2 text-white btn-block"
                               onclick="getFunctionParam('getParamDoc/0/40')"><spring:message code="label.Annuler"/></a>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div>
            <div class="row">
                ...
                <div class="col-lg-3 float-left">
                    <select class="form-select bg-light" id="selectBox" onchange="getFunctionParam(value);"
                        ...
                        <option value="getParamDoc/0/40" class="nav-link navType rounded btn-success "
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    ...
                    <c:choose>
                        <c:when test="${not empty listF and totalPage>0}">
                            <div class="pagination pagination-lg justify-content-center mt-3" dir="ltr">
                                ...
                                <a style="background-color: #2196f3     ;text-align: center;background-size: 100% 100%"
                                   onclick="getParamf(0)" class="pageStyle"><i
                                        class="mdi mdi-arrow-collapse-left m-0"></i></a>
                                <a style="background-color: #2196f3   !important;" onclick="getParamf(${page_db})"
                                ...
                                <c:if test="${totalPage>0}">
                                    <c:forEach begin="${page}" end="${page+toAdd}" var="c">
                                        <a style="background-color: #2196f3   !important; ${page+toAdd}"
                                           onclick="getParamf(${c})"  ${c==number ? 'class=" pageStyle1 active "' : 'class=" pageStyle"'}>${c+1}</a>
                                    </c:forEach>
                                </c:if>
                                ...
                                <a style="background-color: #2196f3   !important;" onclick="getParamf(${page_end})"
                                   class="pageStyle">&raquo;</a>
                                <a style="background-color: #2196f3     ;text-align: center;background-size: 100% 100%"
                                   onclick="getParamf(${totalPage-1})" class="pageStyle"><i
...
<script type="text/javascript">
    function getParamf(vals) {
        getFunctionParam('getParamDoc/' + vals + '/40');
    }
