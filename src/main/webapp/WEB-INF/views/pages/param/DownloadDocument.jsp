                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-4">
                            <ul class="menu-items">
                                ...
                                <li class="bg_hover rounded mt-2 mb-2">
                                    <a id="model3" class="modelchoisi f-16 l_height_2" onclick="fun_affiche2('#file02',this)"><i class="mdi mdi-file-outline"></i> استيراد النفايات غير خطرة من دولة أجنبية </a>
                                </li>
                                <li class="bg_hover rounded mt-2 mb-2">
                                </li>
                                <li class="bg_hover rounded mt-2 mb-2">
                                ...
                                <li class="bg_hover rounded mt-2 mb-2">
                                    <a id="model9" class="modelchoisi f-16 l_height_2" onclick="fun_affiche2('#file06',this)"><i class="mdi mdi-file-outline"></i> تصدير النفايات الخطرة </a>
                                </li>
                                <li class="bg_hover rounded mt-2 mb-2">
                        ...
                        <div class="col-sm-8 col-md-8">
                            ...
                            <div class="row zone_tab collapse" id="file02">
                                <h4> استيراد النفايات غير خطرة من دولة أجنبية
                                </h4>
                                <div class="col-12">
                                    <div class="form-group pb-4">
                                        <label>
