                            ...
                            <%--<div class="col-md-6 card p-4 col-sm-12 col-lg-6">--%>
                                <div class="" style="height: 70px; display: flex; justify-content: center;background-color: #184a00bd     ">
                                    <div class="col-md-12 my-4 text-center">
                                        <strong class="profil text-white">Services et bureaux <i class="ml-2 fa fa-list-alt"></i></strong><br>
                                    </div>
                                </div>
                                <div class="row mt-5">
                                    <form id="myForm">
                                        <div class="col-md-12 col-sm-12 col-lg-12" >
                                            <div class="form-group">
                                                <label>Service ou bureau</label>
                                                <input class="form-control" type="hidden" name="catId" id="catId" value="${Services_bureaux.marqueId}">
                                                <input class="form-control" type="text" name="desigCat" id="desigCat" value="${Services_bureaux.desiMarque}" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Nom Abrege </label>
                                                <%--<textarea class="form-control" type="text" name="abrCat" id="abrCat" rows="3">${Services_bureaux.abrCat}</textarea>--%>
                                                <input class="form-control" type="text" name="abrCat" id="abrCat" value="${Services_bureaux.abrMarque}" required>
                                            </div>
                                        </div>
...
<script>
    ...
    function goToList() {
        window.location.href="/api/param/listeServices_bureaux"
    }
    ...
    function save(){
        ...
        var se = $("#myForm").serializeObject();
            ...
            $.ajax({
                url: '/api/param/addServices_bureaux/'+id, // url where to submit the request
