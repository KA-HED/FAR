                                        ...
                                        <div class="col-lg-12 pr-0">
                                            <div class="row m-0 pt-5">
                                                <div class="col-6 pl-0">
                                                    <h4 class="ml6">
                                                        <span>Détachement des Véhicules  </span>
                                                    </h4>
                                                </div>
                                                <div class="col-6">
                                                    <a class="button text-white bgMyColor float-right"
                                                       href="/api/param/formToAddDetachement_Vehicules/0"><span>Ajouter </span>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <td class="text-center">
                                                        <ul class="list-inline m-0">
                                                            <li class="list-inline-item text-center">
                                                                <a href="/api/param/formToAddDetachement_Vehicules/${f.marqueId}"
