            ...
            <div class="col-xl-5 col-lg-7 mt-5 col-sm-12 mt-5 grid-margin">
                ...
                <div class="card">
                        ...
                        <div class="col-10 mt-4">
                            ...
                            <h3 class="ml6 float-right mb-1">
                                                      <span class="text-wrapper">
                                                        <span class="letters"><span class="letters">Position
                                                      </span>
                            </h3>
                            ...
                            <div class="row p-0">
                                <div class="col-12 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nom" name="nom" value="${Position.nom}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group" <%--dir= "rtl"--%>>
                                        <label>detail</label>
                                        <input type="hidden" id="positionId" name="positionId" value="${Position.positionId}"
                                               class="form-control">

                                        <input type="text" id="nomFr" name="nomFr" value="${Position.nomFr}" class="form-control">
                                    </div>
                                </div>
                    ...
                    <div class="row  mb-4" style="margin:14px;">
                        <a class="btn btn-primary btn-block " onclick="addPosition()">Enregistrer </a>
                        <a class="btn btn-danger-2 text-white btn-block"
                           onclick="getFunctionParam('getParamPosition/0/40')">Annuler</a>
                            ...
                            <div class="row p-0">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nom" value="${Position.nom}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>rechercher</label>
                                        <input type="hidden" id="id_Position" value="${Position.positionId}"
                                               class="form-control">

                                        <input type="text" id="detail" value="${Position.detail}" class="form-control">
                                    </div>
                                </div>
                ...
                <div class="col-12">
                    <table id="example2" class="table tablee table-hover">
                        ...
                        <c:forEach items="${listF}" var="f">
                            ...
                            <tr id="tr-${f.positionId}">
                                     <td>${f.nom}</td>
                                     <td>${f.nomFr}</td>
                                    <td class="text-center">
                                        <ul class="list-inline m-0">
                                            <li class="list-inline-item">
                                                <button onclick="updatePosition(${f.positionId})"
                                            ...
                                            <li class="list-inline-item">
                                                <button onclick="delete_Position(${f.positionId})"
                    ...
                    <c:choose>
                        <c:when test="${not empty listF}">
                            <div class="pagination pagination-lg justify-content-center mt-3" dir="ltr">
                                ...
                                <a style="background-color: #2196f3     ;text-align: center;background-size: 100% 100%" onclick="getParamPosition(0)" class="pageStyle"><i class="mdi mdi-arrow-collapse-left m-0"></i></a>
                                <a  style="background-color: #2196f3   !important;" onclick="getParamPosition(${page_db})" class="pageStyle">&laquo;</a>
                                ...
                                <c:if test="${totalPage>0}">
                                    <c:forEach begin="${page}" end="${page+toAdd}" var="c">
                                        <a style="background-color: #2196f3   !important; ${page+toAdd}" onclick="getParamPosition(${c})"  ${c==number ? 'class=" pageStyle1 active "' : 'class=" pageStyle"'}>${c+1}</a>
                                    </c:forEach>
                                </c:if>
                                ...
                                <a style="background-color: #2196f3   !important;" onclick="getParamPosition(${page_end})" class="pageStyle">&raquo;</a>
                                <a style="background-color: #2196f3     ;text-align: center;background-size: 100% 100%" onclick="getParamPosition(${totalPage-1})" class="pageStyle"><i class="mdi mdi-arrow-collapse-right m-0"></i></a>
...
<script type="text/javascript">
    ...
    function addPosition() {
        ...
        var Position = $("#Form_position").serializeObject();
        ...
        $.ajax({
            ...
            url: "/api/addPosition/0"+positionId,
            ...
            success: function (response) {
                ...
                getFunctionParam('getParamPosition/0/40')
            },
