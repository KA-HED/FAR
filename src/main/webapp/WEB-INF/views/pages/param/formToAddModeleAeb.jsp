                        ...
                        <div class="card-body col-md-12" style="background-color: white">
                            ...
                            <%--<div class="col-md-6 card p-4 col-sm-12 col-lg-6">--%>
                                <div class="" style="height: 70px; display: flex; justify-content: center;background-color: #184a00bd     ">
                                    ...
                                    <form id="myForm">
                                        <input type="hidden" id="modeleId" name="modeleId" value="${ModeleAeb.modeleId}">
                                        <div class="row mt-5">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-lg-4" onchange="S_Cat()" >
                                            <select id="cat" class="form-control" name="categorieAEB">
                                                ...
                                                <c:forEach items="${CategorieAEB}" var="ed">
                                                    <option value="${ed.catId }" ${ed.catId==ModeleAeb.categorieAEB.catId ? 'selected' : ''}>${ed.desigCat }</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                        <div class="col-md-2 col-sm-2 col-lg-1" >
                                            ...
                                            <div class="col-md-4 col-sm-4 col-lg-4" >
                                                <select id="id_sCategorieAEB" name="sCategorieAEB" class="form-control">
                                                    ...
                                                    <c:forEach items="${SCategorieAEB}" var="ed">
                                                        <option value="${ed.sCatId }" ${ed.sCatId==ModeleAeb.sCategorieAEB.sCatId ? 'selected' : ''}>${ed.desigSCat }</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4 col-sm-4 col-lg-4" >
                                                <select id="Marque" class="form-control" name="marqueAEB">
                                                    ...
                                                    <c:forEach items="${MarqueAEB}" var="ed">
                                                        <option value="${ed.marqueId }" ${ed.marqueId==ModeleAeb.marqueAEB.marqueId ? 'selected' : ''}>${ed.desiMarque }</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4 col-sm-4 col-lg-4" >
                                                <select id="type" class="form-control" name="typeAEB">
                                                    ...
                                                    <c:forEach items="${TypeAEB}" var="ed">
                                                        <option value="${ed.typeId }" ${ed.typeId==ModeleAeb.typeAEB.typeId ? 'selected' : ''}>${ed.desigType }</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4 col-sm-4 col-lg-4" >
                                                <select id="Version" class="form-control" name="versionAeb">
                                                    ...
                                                    <c:forEach items="${VersionAeb}" var="ed">
                                                        <option value="${ed.versionId }" ${ed.versionId==ModeleAeb.versionAeb.versionId ? 'selected' : ''}>${ed.desigVersion }</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row ">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-lg-4" >
                                                <input class="form-control" type="text" name="designation" id="designation" value="${ModeleAeb.designation}" required>
                                            </div>
                                            <div class="col-md-2 col-sm-2 col-lg-2" >
                                                    <label>Pays </label>
                                            </div>
                                            <div class="col-md-3 col-sm-3 col-lg-3" >
                                                <select id="paysId" name="paysId" class="form-control">
                                                    <option selected>Choose...</option>
                                                    <c:forEach items="${Pays}" var="ed">
                                                        <option value="${ed.pyId }" ${ed.pyId==ModeleAeb.paysId.pyId ? 'selected' : ''}>${ed.nomPays }</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row ">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-lg-4" >
                                                <input class="form-control" type="text" name="nsn" id="nsn" value="${ModeleAeb.nsn}"  required>
                                            </div>
                                            <div class="col-md-2 col-sm-2 col-lg-2" >
                                            ...
                                            <div class="col-md-3 col-sm-3 col-lg-3" >
                                                ...
                                                <input class="form-control" type="number" name="prixUnitaire"  value="${ModeleAeb.prixUnitaire}"   id="prix"  required>
                                            </div>
                                        </div>
                                        <div class="row ">
                                            <div class="col-md-2 col-sm-2 col-lg-1" >
                                            ...
                                            <div class="col-md-4 col-sm-4 col-lg-4" >
                                                <input class="form-control" type="text" name="nomenclature"  value="${ModeleAeb.nomenclature}"   id="nomenclature"  required>
                                            </div>
                                            <div class="col-md-2 col-sm-2 col-lg-2" >
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-lg-4" >
                                                <input class="form-control" type="text" name="parti" id="parti"  required>
                                            </div>
                                            <div class="col-md-2 col-sm-2 col-lg-2" >
...
var vals=$("#cat").val();
    ...
    function save(){
        ...
        var se = $("#myForm").serializeObject();
            ...
            $.ajax({
                url: '/api/param/addModeleAeb/'+id, // url where to submit the request
    ...
    function addobj() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                goToLien_menu('/api/param/listeModeleAeb',12)
            },
