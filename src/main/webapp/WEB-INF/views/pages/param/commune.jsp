            ...
            <div class="col-xl-5 col-lg-7 mt-5 col-sm-12 mt-5 grid-margin">
                ...
                <div class="card">
                            ...
                            <div class="row p-0">
                                ...
                                <div class="col-12">
                                    <div class="form-group" <%--dir= "rtl"--%>>
                                        <label>بلدية</label>
                                        <input type="hidden" id="id_Commune" value="${Commune.id_commune}"
                                               class="form-control">
                    ...
                    <div class="row  mb-4" style="margin:14px;">
                        <a class="btn btn-primary btn-block " onclick="addCommune()"><spring:message
                                code="label.Enregistrer"/> </a>
                        <a class="btn btn-danger-2 text-white btn-block"
                           onclick="getFunctionParam('getParamCommune/0/40')"><spring:message code="label.Annuler"/></a>
                                ...
                                <td class="text-center">
                                    <ul class="list-inline m-0">
                                        <li class="list-inline-item">
                                            <button onclick="updateCommune(${f.id_commune})"
                                        ...
                                        <li class="list-inline-item">
                                            <button onclick="delete_Commune(${f.id_commune})"
                    ...
                    <c:choose>
                        <c:when test="${not empty listF}">
                            <div class="pagination pagination-lg justify-content-center mt-3" dir="ltr">
                                ...
                                <a style="background-color: #2196f3     ;text-align: center;background-size: 100% 100%" onclick="getParamCommune(0)" class="pageStyle"><i class="mdi mdi-arrow-collapse-left m-0"></i></a>
                                <a  style="background-color: #2196f3   !important;" onclick="getParamCommune(${page_db})" class="pageStyle">&laquo;</a>
                                ...
                                <c:if test="${totalPage>0}">
                                    <c:forEach begin="${page}" end="${page+toAdd}" var="c">
                                        <a style="background-color: #2196f3   !important; ${page+toAdd}" onclick="getParamCommune(${c})"  ${c==number ? 'class=" pageStyle1 active "' : 'class=" pageStyle"'}>${c+1}</a>
                                    </c:forEach>
                                </c:if>
                                ...
                                <a style="background-color: #2196f3   !important;" onclick="getParamCommune(${page_end})" class="pageStyle">&raquo;</a>
                                <a style="background-color: #2196f3     ;text-align: center;background-size: 100% 100%" onclick="getParamCommune(${totalPage-1})" class="pageStyle"><i class="mdi mdi-arrow-collapse-right m-0"></i></a>
                            ...
                            <div class="text-center" dir="ltr">
                                ...
                                <c:if test="${totalPage>0}">
                                    ...
                                    <select class="custom-select" id="optionselected"
                                            onchange="getParamCommune(this.value)" style="margin: auto; width: 100px">
