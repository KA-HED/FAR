                                    ...
                                    <tr id="tr-${f.id}">
                                         ...
                                         <td class="text-center">
                                           <ul class="list-inline m-0">
                                             ...
                                             <li class="list-inline-item">
                                               <button onclick="delete_famille(${f.id})" class="btn btn-danger btn-sm rounded-circle tab_trash" type="button" data-toggle="tooltip" data-placement="top" title="Supprimer">
