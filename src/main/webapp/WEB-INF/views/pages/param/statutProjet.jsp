                    ...
                    <form name="statutProjet" id="statutProjet">
                        <div class="card" >
                            ...
                            <div class="row  mb-4" style="margin:14px;">
                                ...
                                <a class="btn btn-danger-2 text-white btn-block" onclick="getFunctionParam('getParamStatutProjet/0/40')"><spring:message code="label.Annuler"/></a>
...
function getParamf(vals){
	...
	getFunctionParam('getParamStatutProjet/'+vals+'/40');
    ...
    function addstatutProjet(){
        ...
        $.ajax({
            ...
            success : function(response) {
            	getFunctionParam('getParamStatutProjet/0/40');
