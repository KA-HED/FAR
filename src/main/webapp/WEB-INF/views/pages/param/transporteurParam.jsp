                    ...
                    <div class="photo  hvr-buzz-out" >
                        ...
                        <div class="card" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select  data-width="100%" multiple id="code" class="form-control select2" required="required">
                                                    <c:forEach items="${code }" var="c">
                                                        <option <c:forEach items="${transporteurP.code }" var="tc"> <c:if test="${c.id_code == tc.id_code}">selected</c:if> </c:forEach> value="${c.id_code}">${c.nom_fr }</option>
                                                    </c:forEach>
                                                </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                               ...
                                               <fmt:formatDate pattern="yyyy-MM-dd" dateStyle="long" var="date_field" value="${transporteurP.dateFin }"/>
                                                <input  required type="date" id="dateFin" value="${date_field}" class="form-control">
                            ...
                            <div class="row b mb-4" style="margin:14px;">
                                ...
                                <a class="btn btn-danger-2 text-white btn-block" onclick="getFunctionParam('getParamTransporteur/0/40')"><spring:message code="label.Annuler"/></a>
                            ...
                            <c:choose>
                                <c:when test="${not empty listF}">
                                    <div class="pagination pagination-lg justify-content-center mt-3" dir="ltr">
                                        ...
                                        <a style="background-color: #2196f3     ;text-align: center;background-size: 100% 100%" onclick="getParamT(0)" class="pageStyle"><i class="mdi mdi-arrow-collapse-left m-0"></i></a>
                                        <a  style="background-color: #2196f3   !important;" onclick="getParamT(${page_db})" class="pageStyle">&laquo;</a>
                                        ...
                                        <c:if test="${totalPage>0}">
                                            <c:forEach begin="${page}" end="${page+toAdd}" var="c">
                                                <a style="background-color: #2196f3   !important; ${page+toAdd}" onclick="getParamT(${c})"  ${c==number ? 'class=" pageStyle1 active "' : 'class=" pageStyle"'}>${c+1}</a>
                                            </c:forEach>
                                        </c:if>
                                        ...
                                        <a style="background-color: #2196f3   !important;" onclick="getParamT(${page_end})" class="pageStyle">&raquo;</a>
                                        <a style="background-color: #2196f3     ;text-align: center;background-size: 100% 100%" onclick="getParamT(${totalPage-1})" class="pageStyle"><i class="mdi mdi-arrow-collapse-right m-0"></i></a>
