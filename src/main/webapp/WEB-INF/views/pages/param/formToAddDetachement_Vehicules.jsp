                            ...
                            <%--<div class="col-md-6 card p-4 col-sm-12 col-lg-6">--%>
                                <div class="" style="height: 70px; display: flex; justify-content: center;background-color: #184a00bd     ">
                                    <div class="col-md-12 my-4 text-center">
                                        <strong class="profil text-white">Détachement des Véhicules<i class="ml-2 fa fa-list-alt"></i></strong><br>
                                    </div>
                                </div>
                                <div class="row mt-5">
                                    <form id="myForm">
                                        <div class="col-md-12 col-sm-12 col-lg-12" >
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="hidden" name="catId" id="catId" value="${Detachement_Vehicules.marqueId}">
                                                <input class="form-control" type="text" name="desigCat" id="desigCat" value="${Detachement_Vehicules.desiMarque}" required>
                                            </div>
                                            <div class="form-group">
                                                <label>ABREVIATION </label>
                                                <%--<textarea class="form-control" type="text" name="abrCat" id="abrCat" rows="3">${Detachement_Vehicules.abrCat}</textarea>--%>
                                                <input class="form-control" type="text" name="abrCat" id="abrCat" value="${Detachement_Vehicules.abrMarque}" required>
                                            </div>
                                        </div>
...
<script>
    ...
    function goToList() {
        window.location.href="/api/param/listeDetachement_Vehicules"
    }
    ...
    function save(){
        ...
        var se = $("#myForm").serializeObject();
            ...
            $.ajax({
                url: '/api/param/addDetachement_Vehicules/'+id, // url where to submit the request
