                                        ...
                                        <div class="col-lg-12 pr-0">
                                            <div class="row m-0 pt-5">
                                                <div class="col-6 pl-0">
                                                    <h4 class="ml6">
                                                        <span>Détenteurs des véhicules  </span>
                                                    </h4>
                                                </div>
                                                <div class="col-6">
                                    ...
                                    <div id="ta" class="container__inner content__description" style="padding-bottom: 10px;   min-height: 201px;">
                                        ...
                                        <table class="table table-bordered table-checkable  tablee table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center">Date Grade</th>
                                                <th class="text-center">unité</th>
                                                <th class="text-center">Organe d’emploi </th>
                                                <th class="text-center"> Groupment </th>
                                                <th class="text-center">Militaire</th>
