                ...
                <form name="code" id="code">
                    <div class="card">
                                ...
                                <h3 class="ml6 float-right mb-1">
                                                      <span class="text-wrapper">
                                                        <span class="letters"><span class="letters"><spring:message
                                                                code="label.MoyendeTransport"/></span></span>
                                                      </span>
                                </h3>
                                ...
                                <div class="row p-0">
                                    <div class="col-12 mt-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="nom_fr" value="${moyenTrans.nom_fr}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" id="id_moyenTransport"
                                                   value="${moyenTrans.id_moyenTransport}" class="form-control">

                                            <input type="text" id="nom_ar" value="${moyenTrans.nom_ar}"
                                                   class="form-control">
                                        </div>
                                    </div>
                        ...
                        <div class="row  mb-4" style="margin:14px;">
                            <a class="btn btn-success btn-block " onclick="addMoyenTrans()"><spring:message
                                    code="label.Enregistrer"/> </a>
                            <a class="btn btn-danger-2 text-white btn-block"
                               onclick="getFunctionParam('getParamMoyenTransport/0/40')"><spring:message
                                ...
                                <td class="text-center">
                                    <ul class="list-inline m-0">
                                        <li class="list-inline-item">
                                            <button onclick="updateMoyenTrans(${f.id_moyenTransport})"
                                        ...
                                        <li class="list-inline-item">
                                            <button onclick="deleteMoyenTrans(${f.id_moyenTransport})"
                        ...
                        <c:when test="${not empty listF}">
                            <div class="pagination pagination-lg justify-content-center mt-3" dir="ltr">
                                ...
                                <a style="background-color: #2196f3     ;text-align: center;background-size: 100% 100%"
                                   onclick="getParamMoyen(0)" class="pageStyle"><i
                                        class="mdi mdi-arrow-collapse-left m-0"></i></a>
                                <a style="background-color: #2196f3   !important;" onclick="getParamMoyen(${page_db})"
                                ...
                                <c:if test="${totalPage>0}">
                                    <c:forEach begin="${page}" end="${page+toAdd}" var="c">
                                        <a style="background-color: #2196f3   !important; ${page+toAdd}"
                                           onclick="getParamMoyen(${c})"  ${c==number ? 'class=" pageStyle1 active "' : 'class=" pageStyle"'}>${c+1}</a>
                                    </c:forEach>
                                </c:if>
                                ...
                                <a style="background-color: #2196f3   !important;" onclick="getParamMoyen(${page_end})"
                                   class="pageStyle">&raquo;</a>
                                <a style="background-color: #2196f3     ;text-align: center;background-size: 100% 100%"
                                   onclick="getParamMoyen(${totalPage-1})" class="pageStyle"><i
                            ...
                            <div class="text-center" dir="ltr">
                                ...
                                <c:if test="${totalPage>0}">
                                    ...
                                    <select class="custom-select" id="optionselected"
                                            onchange="getParamMoyen(this.value)" style="margin: auto; width: 100px">
    ...
    function addMoyenTrans() {
        ...
        $.ajax({
            ...
            success: function (response) {
                getFunctionParam('getParamMoyenTransport/0/40');
