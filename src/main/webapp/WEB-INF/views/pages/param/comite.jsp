                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select  required id="adresse" class="form-select bg-light"  style="height: 40px">
                                                    <option selected value="1" ${comite.adresse=='1'?'selected':''}>EIE</option>
                                                    <option value="2" ${comite.adresse=='2'?'selected':''}>CT</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-12" dir="ltr">
                                                    ...
                                                    <select id="region" class="form-select bg-light" style="height: 40px">
                                                        ...
                                                        <c:forEach items="${region }" var="r">
                                                            <option value="${r.id}"
                                                                ${comite.region.id== r.id ?'selected':''}>${r.nom_fr }
                                                            </option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
