                            ...
                            <%--<div class="col-md-6 card p-4 col-sm-12 col-lg-6">--%>
                                <div class="" style="height: 70px; display: flex; justify-content: center;background-color: #184a00bd     ">
                                    <div class="col-md-12 my-4 text-center">
                                        <strong class="profil text-white">Détenteurs des véhicules   <i class="ml-2 fa fa-list-alt"></i></strong><br>
                                    </div>
                                </div>
                                <div class="row mt-5">
                                    <form id="myForm">
                                        <div class="col-md-12 col-sm-12 col-lg-12" >
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="hidden" name="catId" id="catId" value="${AbcDetenteur.marqueId}">
                                                <input class="form-control" type="text" name="desigCat" id="desigCat" value="${AbcDetenteur.desiMarque}" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Nom Abrege </label>
                                                <%--<textarea class="form-control" type="text" name="abrCat" id="abrCat" rows="3">${AbcDetenteur.abrCat}</textarea>--%>
                                                <input class="form-control" type="text" name="abrCat" id="abrCat" value="${AbcDetenteur.abrMarque}" required>
                                            </div>
                                        </div>
...
<script>
    ...
    function goToList() {
        window.location.href="/api/param/listeAbcDetenteur"
    }
    ...
    function save(){
        ...
        var se = $("#myForm").serializeObject();
            ...
            $.ajax({
                url: '/api/param/addAbcDetenteur/'+id, // url where to submit the request
