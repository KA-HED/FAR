                ...
                <form name="prefecture" id="prefecture">
                    <div class="card">
                        ...
                        <div class="row  mb-4" style="margin:14px;">
                            ...
                            <a class="btn btn-danger-2 text-white btn-block" onclick="getFunctionParam('getParamPrefecture/0/40')"><spring:message code="label.Annuler" /></a>
                        ...
                        <c:choose>
                            <c:when test="${not empty listF}">
                                <div class="pagination pagination-lg justify-content-center mt-3" dir="ltr">
                                    ...
                                    <a style="background-color: #2196f3     ;text-align: center;background-size: 100% 100%" onclick="getParamPre(0)" class="pageStyle"><i class="mdi mdi-arrow-collapse-left m-0"></i></a>
                                    <a  style="background-color: #2196f3   !important;" onclick="getParamPre(${page_db})" class="pageStyle">&laquo;</a>
                                    ...
                                    <c:if test="${totalPage>0}">
                                        <c:forEach begin="${page}" end="${page+toAdd}" var="c">
                                            <a style="background-color: #2196f3   !important; ${page+toAdd}" onclick="getParamPre(${c})"  ${c==number ? 'class=" pageStyle1 active "' : 'class=" pageStyle"'}>${c+1}</a>
                                        </c:forEach>
                                    </c:if>
                                    ...
                                    <a style="background-color: #2196f3   !important;" onclick="getParamPre(${page_end})" class="pageStyle">&raquo;</a>
                                    <a style="background-color: #2196f3     ;text-align: center;background-size: 100% 100%" onclick="getParamPre(${totalPage-1})" class="pageStyle"><i class="mdi mdi-arrow-collapse-right m-0"></i></a>
