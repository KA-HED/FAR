                                               ...
                                               <div class="flip-card">
                                                   <div class="flip-card-inner">
                                                       ...
                                                       <div class="flip-card-back" >
                                                            <h6>Article</h6>
                                                          <button onclick="getFunctionParam('getParamArticle/0/40')" type="button" class="btn btn-primary" style="background-color:white;color: #d59d32 !important;"> Afficher</button>
                                               </div>
                                            </div>
                                         </div>
                                 </div>
                                 ...
                                 <div class="col-xl-1 col-lg-1 col-md-4 col-sm-6 col-12">
                                     <div class="flip-card">
                                         <div class="flip-card-inner">
                                             ...
                                             <div class="flip-card-back" >
                                                  <h6>Entr�es</h6>
                                                 <button onclick="getFunctionParam('getParamReception/0/40')" type="button" class="btn btn-primary" style="background-color:white;color: #d59d32;"> Afficher</button>
                                 ...
                                 <div class="col-xl-1 col-lg-1 col-md-4 col-sm-6 col-12">
                                     <div class="flip-card">
                                         <div class="flip-card-inner">
                                             ...
                                             <div class="flip-card-back" >
                                                  <h6>Alimentations</h6>
                                                 <button onclick="getFunctionParam('getParamAlimentation/0/40')" type="button" class="btn btn-primary" style="background-color:white;color: #d59d32 !important;"> Afficher</button>
                                             </div>
                                         </div>
                                     </div>
