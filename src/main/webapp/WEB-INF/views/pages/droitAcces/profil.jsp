    ...
    <div class="content-wrapper">
        <div class="row" style="margin-top: 100px;display:flex;">
            ...
            <div class="col-md-6 card p-4 col-sm-12 col-lg-6">
                        <div class="" style="height: 70px; display: flex; justify-content: center;background-color: #2196f3     ">
...
<script type="text/javascript">
    ...
    function goToList() {
        window.location.href="/api/getListProfile/0/40"
}
...
function success() {
    ...
    function getParamProfil(vals){
        window.location.href='/api/getListProfile/'+vals+'/40';
    }
