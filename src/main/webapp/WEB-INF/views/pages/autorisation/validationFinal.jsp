  ...
  <div class="main-panel " style="margin-top:120px">
      ...
      <div class="col-12" dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}">
        <div class="jumbotron p-3">
            Demande numéro : <span class="h4 font-weight-bold" style="color: #3b5998">   ${demande.num_notification}</span><span>
        </span>
        </div>
                            ...
                            <form name="doc" id="doc">
                                <div class="card">
                                    ...
                                    <div class="row  mb-4" style="margin:14px;">
                                        ...
                                        <a class="btn btn-secondary btn-block"  href="/api/getListeAutorisation/${type }/0/40/0" style="background: #f95f5f;"><spring:message code='label.Annuler'/> </a>
                                    </div>
                                </div>
                            </form>
                        </div>
