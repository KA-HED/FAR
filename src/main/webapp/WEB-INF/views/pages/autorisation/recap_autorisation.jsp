    ...
    <div class="col-12">
        ...
        <nav aria-label="breadcrumb" dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}" >
            <ol class="breadcrumb ml-4">
                ...
                <li class="breadcrumb-item active" style="${pageContext.response.locale!='ar'?'':'margin-right:4rem !important'}" aria-current="page"><a href="/api/getListeAutorisation/${type}/0/40/0" >${p_page}</a></li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="col-md-10 col-sm-12">
        <div class="row p-0 mb-2">
            <div class="col-md-auto col-sm-6 m-1">
                <a href="/api/getListeAutorisation/${type}/0/40/0" class="btn btn-primary btn-block"><i class="${pageContext.response.locale=='ar'?'fa fa-arrow-right':'fa fa-arrow-left'} ml-2"></i><spring:message code="label.Retour"/></a>
            </div>
            <div class="col-md-auto col-sm-6 m-1">
             ...
             <c:if test="${notification.statut.id_statut_projet==33}">
                 <div class="col-md-auto col-sm-6  m-1">
                     <a style="background-color:  #d59d32" type="button" onclick="EditAutorisation('${notification.id_notification}')" class="  btn btn-primary btn-block"><i class="fa fa-user-edit ml-2"></i><spring:message code="label.accespourmodifier"/></a>
                 </div>
                 <div class="col-md-auto col-sm-6  m-1">
            ...
            <c:if test="${(notification.statut.id_statut_projet==38 && type=='XD'  && user.poste.id_Poste!=3) || notification.statut.id_statut_projet==38 && type=='XD' && user.compteId!=notification.compteAffecte.compteId}">
            <div class="col-md-auto col-sm-6  m-1">
            ...
            <c:if test="${(notification.statut.id_statut_projet==38 && type=='TR'  && user.poste.id_Poste!=3) || notification.statut.id_statut_projet==38 && type=='TR'  && user.compteId!=notification.compteAffecte.compteId}">
            <div class="col-md-auto col-sm-6  m-1">
            ...
            <c:if test="${(notification.statut.id_statut_projet==38 && type!='XD' && type!='TR'  && user.poste.id_Poste!=3) || notification.statut.id_statut_projet==38 && type!='XD' && type!='TR'  && user.compteId!=notification.compteAffecte.compteId}">
                <div class="col-md-auto col-sm-6  m-1">
            ...
            <div class="col-md-auto col-sm-6  m-1">
                ...
                <c:if test="${(notification.statut.id_statut_projet==40 && type=='ZF' && user.poste.id_Poste!=1 && user.poste.id_Poste!=3) || notification.statut.id_statut_projet==40 && type=='ZF' && user.poste.id_Poste!=1 && user.compteId!=notification.compteAffecte.compteId}">
                    <div class="col-md-auto col-sm-6  m-1">
                            <a type="button" class="btn btn-primary btn-block" href="/api/down_sign_docNotif/${type}/${notification.id_notification }"><i class="fa fa-signature ml-2"></i> <spring:message code="label.Telechargeretsignerlautorisation"/></a>
                    </div>
                </c:if>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="accordion" id="accordionExample">
                                    ...
                                    <div class="row m-0 p-0 mt-2">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" dir="${pageContext.response.locale=='ar'?'ltr':''}" disabled value="${notification.code.nom_fr}" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" dir="${pageContext.response.locale=='ar'?'ltr':''}" disabled value="${notification.code.nom_ar}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row m-0 p-0 mt-2">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <c:choose>
                                                    <c:when test="${notification.zonneFranche.nom_fr.equals('Autre')}">
                                                        <input type="text" disabled value="${notification.autre4}" class="form-control">
                                                    </c:when>
                                                    <c:otherwise>
                                ...
                                <div class="card-header panel-heading" id="headingOne">
                                    <h5 class="mb-0 panel-title">
                                        <a class="accordion-toggle btn  text-white" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" style="${pageContext.response.locale=='ar'?'text-align:right;':'text-align:left;'}">
                                            <i class="icon fa fa-user-circle mr-3"></i><spring:message code="label.ExportateurNotifiant"/>
                                        </a>
                                    </h5>
                                </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" dir="${pageContext.response.locale=='ar'?'ltr':''}" disabled value="${notification.codeNationalXD}">
                                                    </div>
                                                </div>
                                                <c:if test="${!notification.zf_et.equals('ET')}">
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" dir="${pageContext.response.locale=='ar'?'ltr':''}" disabled value="${notification.codeNationalIm}">
                                                        </div>
                                                    </div>
                                                </c:if>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="${notification.importateur.adresse_fr}" dir="${pageContext.response.locale=='ar'?'ltr':''}" disabled type="text"
                                                               class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3" style="direction: ${pageContext.response.locale=='ar'?'ltr !important':'' }">
                                                            ...
                                                            <input value="${notification.importateur.tel}" disabled class="form-control" aria-label="telephone" aria-describedby="basic-addon1">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <c:if test="${notification.zf_et=='TR'}">
                                            <div class="row mb-2">
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="${notification.genre}" disabled type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label> <spring:message code="label.Qualite"/> </label>
                                                        <input value="${notification.qualite}" disabled type="text" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label><spring:message code="label.Telephone"/></label>
                                                        <input class="form-control" type="tel" disabled value="${notification.tel}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label><spring:message code="label.Adresse"/></label>
                                                        <input class="form-control" type="text" dir="${pageContext.response.locale=='ar'?'ltr':''}" disabled value="${notification.adresse}">
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="card-body">
                                    <c:if test="${notification.zf_et=='XD'}">
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label><spring:message code="label.paysdestinataire"/></label>
                                                    <input class="form-control" type="text" disabled value="${pageContext.response.locale=='ar'?notification.pays_destination.nom_ar:notification.pays_destination.nom_fr}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-2">
                                    ...
                                    <c:if test="${notification.zf_et!='XD'}">
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label> <spring:message code="label.Adresse"/> </label>
                                                    <input type="text" disabled dir="${pageContext.response.locale=='ar'?'ltr':''}" value="${notification.importateur.adresse_fr}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label> <spring:message code="label.Email"/> </label>
                                                    <input type="text" disabled dir="${pageContext.response.locale=='ar'?'ltr':''}" value="${notification.importateur.mail}" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3" style="direction: ${pageContext.response.locale=='ar'?'ltr':''}">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text1" id="basic-addon1" style="background-color: #e9ecef !important;"><img src="${pageContext.request.contextPath}/assets/images/MA.png" style="width: 25px"/><small style="font-weight:500; color: black"> (+212)</small></span>
                                                            </div>
                                                            <input value="${notification.importateur.tel}" disabled class="form-control" aria-label="telephone" aria-describedby="basic-addon1">
                                                        </div>
                                                    </div>
                                ...
                                <div class="card-header panel-heading" id="headingThree">
                                    <h5 class="mb-0 panel-title">
                                        <a class="accordion-toggle btn collapsed  text-white" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" style="${pageContext.response.locale=='ar'?'text-align:right;':'text-align:left;'}">
                                            ...
                                            <c:if test="${notification.zf_et=='TR'}">
                                                <spring:message code="label.Autoritedecomptetente"/>
                                            </c:if>
                                        </a>
                                    </h5>
                                </div>
                                <div id="collapseThree" class="collapse fade" aria-labelledby="headingThree" data-parent="#accordionExample">
                                    <div class="card-body">
                                            ...
                                            <div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                <label><spring:message code="label.Adresse"/></label>
                                                                <textarea disabled rows ="2" dir="${pageContext.response.locale=='ar'?'ltr':''}" class="form-control">${notification.autorite.adresse} </textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                <label><spring:message code="label.Telephone"/></label>
                                                                <input disabled class="form-control" value="${notification.autorite.tel}" type="tel">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                        ...
                                        <c:if test="${notification.zf_et=='TR'}">
                                            <div>
                                                <div class="card p-3">
                                                    <div class="card" style="background-color: #d9f2e6; padding:10px">
                                                    <h5 class="card-title"><spring:message code="label.Autoritedetransitcompetente"/></h5>
                                                    <hr style="height:2px;border-width:0;color:#cccccc;background-color:#cccccc; margin-top: -8px"/>
                                                    </div>
                                                    <div class="row mt-4 p-1 m-1">
                                                        <table class="table my_table table-striped table-bordered table-hover" style="text-align: center">
                                                            <thead style="background-color: darkseagreen">
                                                            <tr>
                                                                <th><spring:message code="label.NometPrenom"/></th>
                                                            ...
                                                            <c:if test="${not empty notification.paysAutorites}">
                                                                <c:forEach items="${notification.paysAutorites}" var="tr">
                                                                    <tr>
                                                                        ...
                                                                        <td><c:if test="${not empty tr.url_autorite}">
                                                                            <a href="/downloadFile/${fn:replace(tr.url_autorite,"/assets/myFile/","")}" class="btn btn-primary rounded-circle"><span class="fa fa-download"></span></a>
                                                                        </c:if>
                                                                            <c:if test="${empty tr.url_autorite}">
                                                                                <spring:message code="label.Aucuneautorisation"/>
                                                                            </c:if></td>
                                                                    </tr>
                                                                </c:forEach>
                                                            </c:if>
                                                ...
                                                <div class="card p-3">
                                                    <div class="card" style="background-color: #d9f2e6; padding:10px">
                                                    <h5 class="card-title"><spring:message code="label.Autoritedexportationcomptetente"/></h5>
                                                    <hr style="height:2px;border-width:0;color:#cccccc;background-color:#cccccc; margin-top: -8px"/>
                                                    </div>
                                                    <div class="row mt-4">
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                <label><spring:message code="label.Autoritedecomptetente"/> </label>
                                                                <input disabled class="form-control" value="${notification.autorite.nom_prenom}" type="text">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2 col-sm-12">
                                                            <div class="form-group">
                                                                <label><spring:message code="label.representerpar"/> </label>
                                                                <input disabled class="form-control" value="${notification.autorite.genre_A}" type="text">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                <label><spring:message code="label.Adresse"/></label>
                                                                <textarea dir="${pageContext.response.locale=='ar'?'ltr':''}" disabled rows ="2" class="form-control">${notification.autorite.adresse} </textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                <label><spring:message code="label.Port"/></label>
                                                                <input disabled class="form-control" value="${notification.autorite.port}" type="text">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="card p-3">
                                                    <div class="card" style="background-color: #d9f2e6; padding:10px">
                                                    <h5 class="card-title"><spring:message code="label.Autoritecompetentedimportation"/></h5>
                                                    <hr style="height:2px;border-width:0;color:#cccccc;background-color:#cccccc; margin-top: -8px"/>
                                                    </div>
                                                    <div class="row mt-4">
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                <label><spring:message code="label.Genre"/> </label>
                                                                <input disabled class="form-control" value="${notification.autorite.genre_A_imp}" type="text">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                <label><spring:message code="label.Username"/> </label>
                                                                <input disabled class="form-control" value="${notification.autorite.denomination_imp}" type="text">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                <label><spring:message code="label.Qualite"/> </label>
                                                                <input disabled class="form-control" value="${notification.autorite.poste_imp}" type="text">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                <label><spring:message code="label.Email"/></label>
                                                                <input disabled class="form-control" value="${notification.autorite.email_imp}" type="text">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                <label><spring:message code="label.Tel"/></label>
                                                                <input disabled class="form-control" value="${notification.autorite.tel_imp}" type="tel">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                <label><spring:message code="label.Fax"/></label>
                                                                <input disabled class="form-control" value="${notification.autorite.fax_imp}" type="text">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                <label><spring:message code="label.Adresse"/></label>
                                                                <textarea dir="${pageContext.response.locale=='ar'?'ltr':''}" disabled rows ="2" class="form-control">${notification.autorite.adresse_imp} </textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                <label><spring:message code="label.pay"/> </label>
                                                                <input disabled class="form-control" value="${pageContext.response.locale=='ar'?notification.autorite.pays_imp.nom_ar:notification.autorite.pays_imp.nom_fr}" type="text">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input disabled class="form-control" value="${notification.autorite.nom_prenom_imp}" type="text">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                <label><spring:message code="label.Port"/></label>
                                                                <input disabled class="form-control" value="${notification.autorite.port_imp}" type="text">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div id="collapseFor" class="collapse fade" aria-labelledby="headingFor" data-parent="#accordionExample">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <fmt:parseDate value="${notification.premier}" pattern="yyyy-MM-dd" var="myDate"/>
                                                <fmt:formatDate value='${myDate}' var='startFormat' type='date' pattern='dd-MM-yyyy'/>
                                                <input disabled class="form-control" value="${startFormat}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <fmt:parseDate value="${notification.dernier}" pattern="yyyy-MM-dd" var="myDate"/>
                                                <fmt:formatDate value='${myDate}' var='lastFormat' type='date' pattern='dd-MM-yyyy'/>
                                                <input disabled class="form-control" value="${lastFormat}" type="text">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <c:if test="${!notification.zf_et.equals('XD') && !notification.zf_et.equals('TR')}">
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label><spring:message code="label.Nomdeladestinationfinale"/></label>
                                                    <input disabled class="form-control" value="${notification.installationAutorise.raison.equals('Autre')?notification.autre3:notification.installationAutorise.raison}" type="text">
                                                </div>
                                            </div>
                                        </c:if>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <c:if test="${notification.typeconditionnement.typeConditionement_id!=4}">
                                                ...
                                                <c:if test="${notification.typeconditionnement.typeConditionement_id==4}">
                                                    <input disabled class="form-control" value="${notification.autre2}" type="text">
                                                </c:if>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <c:if test="${notification.operation=='traitement' || notification.operation=='المعالجة'}">
                                                    <label><spring:message code="label.Operationdelimination"/></label>
                                                </c:if>
                                                <c:if test="${notification.operation=='valorisation' || notification.operation=='التثمين'}">
                                                    <label><spring:message code="label.Operationdevalorisation"/></label>
                                                </c:if>
                                                <textarea disabled class="form-control" type="text">${notification.operationdelimination}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label>Code H</label>
                                                <textarea disabled class="form-control" type="text">${notification.codeH}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <c:if test="${notification.zf_et=='ET' ||notification.zf_et=='XD' || notification.zf_et=='ZF'}">
                            <div class="panel">
                                ...
                                <div id="collapseZero" class="collapse fade" aria-labelledby="headingZero" data-parent="#accordionExample">
                                    <div class="card-body">
                                        <c:if test="${(notification.zf_et=='XD' || notification.zf_et=='ZF') && (notification.classification.id_classification==1 && fn:startsWith(notification.code.nom_fr, '18')!=true)}">
                                            <div class="table-responsive">
                                                ...
                                                <c:forEach items="${notification.transporteur}" var="Tr_l">
                                                    <tr>
                                                        ...
                                                        <td>${fn:replace(Tr_l.tel, " ", "")} </td>
                                                        <td>${fn:replace(Tr_l.fax, " ", "")} </td>
                                                        <td dir="${pageContext.response.locale=='ar'?'ltr':''}">${Tr_l.adresse} </td>
                                                    </tr>
                                                </c:forEach>
                                                </tbody>
                                            </table>
                                        ...
                                        <c:if test="${(notification.zf_et=='XD' || notification.zf_et=='ZF') && (notification.classification.id_classification==2 || fn:startsWith(notification.code.nom_fr, '18'))}">
                                        <div class="table-responsive">
                                            <table class="table my_table table-striped table-bordered table-hover" style="text-align: center">
                                                <thead style="background-color: darkseagreen">
                                                <tr>
                                            ...
                                            <table class="table my_table table-striped table-bordered table-hover" style="text-align: center">
                                                ...
                                                <c:if test="${not empty notification.transporteur_etranger}">
                                                    <c:forEach items="${notification.transporteur_etranger}" var="tr">
                                                        <tr>
                                                            <c:if test="${tr.type=='tn'}">
                                                                <td class="text-center">${tr.raison_social}</td>
                                                                <td class="text-center">${tr.num_matricule}</td>
                                                                <td class="text-center">${tr.typeVehicule}</td>
                                                                <td class="text-center">${tr.personne}</td>
                                                                <td class="text-center"><a download="assurance" target="_blank" href="${fn:replace(tr.url_assurance, "/assets/myFile/","/dowload_uploaded/" )}" class="btn btn-success rounded"><span class="fa fa-download"></span></a></td>
                                                            </c:if>
                                                        </tr>
                                                    </c:forEach>
                                                ...
                                                <c:if test="${not empty declaration}">
                                                    <tr class="bg-primary">
                                                        <td class="text-center">${declaration.transporteurParam.nom}</td>
                                                        <td class="text-center">${declaration.transporteurParam.identifiant}</td>
                                                        <td class="text-center">${declaration.transporteurParam.tel}</td>
                                                        <td class="text-center">${declaration.transporteurParam.fax}</td>
                                                        <td class="text-center">${declaration.transporteurParam.adresse}</td>
                                                    </tr>
                                                </c:if>
                                                <c:if test="${(empty notification.transporteur_etranger && empty declaration)}">
                                                    <tr>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            ...
                                            <tr>
                                                ...
                                                <th class=""> <spring:message code="label.Fax"/></th>
                                                <th class=""> <spring:message code="label.Personneacontacter"/></th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <c:if test="${not empty notification.transporteur_etranger}">
                                                <c:forEach items="${notification.transporteur_etranger}" var="tr">
                                                    <tr>
                                                        ...
                                                        <c:if test="${!notification.zf_et.equals('TR')}">
                                                            ...
                                                            <td class="text-center" dir="${pageContext.response.locale=='ar'?'ltr':''}">${tr.adresse}</td>
                                                            <td class="text-center" dir="ltr">${!tr.tel.equals('+212')?fn:replace(tr.tel, " ", ""):''}</td>
                                                            <td class="text-center">${tr.fax}</td>
                                                            <td class="text-center">${tr.personne}</td>
                                                        </c:if>
                                                    </tr>
                                                </c:forEach>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <c:if test="${not empty notification.producteurs}">
                                                <c:forEach items="${notification.producteurs}" var="tr">
                                                    <tr>
                                                        <td>${tr.nom_fr!=null?tr.nom_fr:tr.nom_ar}</td>
                                                        <td>${tr.contact_fr}</td>
                                                        <td dir="${pageContext.response.locale=='ar'?'ltr':''}">${tr.adresse_fr}</td>
                                                        <td>
                                                            <c:if test="${pageContext.response.locale=='ar'}">
                                                                <span dir="ltr">${fn:replace(tr.tel, " ", "")}</span>
                                                            </c:if>
                                                            <c:if test="${pageContext.response.locale!='ar'}">
                                                                <span>${fn:replace(tr.tel, " ", "")}</span>
                                                            </c:if>
                                                        </td>
                                                        <td>${tr.fax}</td>
                                                        <td>${tr.mail}</td>
                                    ...
                                    <c:if test="${notification.zf_et!='XD'}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label><spring:message code="label.Adresse"/></label>
                                                    <textarea disabled rows ="2" dir="${pageContext.response.locale=='ar'?'ltr':''}" class="form-control">${notification.producteur.adresse_fr} </textarea>
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3" style="direction: ${pageContext.response.locale=='ar'?'ltr':''}">
                                                            ...
                                                            <input value="${notification.producteur.tel}" disabled class="form-control" aria-label="telephone" aria-describedby="basic-addon1">
                                                        </div>
                                                    </div>
                                                </div>
                                            </c:if>
                                ...
                                <div class="card-body">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3" style="direction: ${pageContext.response.locale=='ar'?'ltr':''}">
                                                        ...
                                                        <input value="${notification.eliminateur.tel}" disabled class="form-control" aria-label="telephone" aria-describedby="basic-addon1">
                                                    </div>
                                                </div>
                                            </div>
                                        </c:if>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label><spring:message code="label.Adresse"/></label>
                                                <textarea disabled rows ="2" dir="${pageContext.response.locale=='ar'?'ltr':''}" class="form-control">${notification.eliminateur.adresse_fr} </textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <c:if test="${notification.zf_et.equals('ZF') && notification.classification.id_classification==1 && not empty notification.url_certicat_elimination}">
                            <div class="panel">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table my_table table-striped table-bordered table-hover"
                                                       style="text-align: ${pageContext.response.locale!="ar"?'left':'right'}">
                        ...
                        <c:if test="${notification.zf_et.equals('ZF') && notification.classification.id_classification==2 && not empty notification.url_document_mouvement}">
                            <div class="panel">
                        ...
                        <c:if test="${notification.zf_et.equals('ZF') && notification.classification.id_classification ==1 && declaration.etat != null}">
                            <div class="panel">
                                            ...
                                            <table class="table my_table table-striped table-bordered table-hover" style="text-align: center">
                                                ...
                                                <c:if test="${notification.zf_et=='XD'}">
                                                    ...
                                                    <c:if test="${not empty notification.url_lettre}">
                                                        <td style="width: 93%"><spring:message code="label.Avis"/></td>
...
<script>
    ...
    function EditAutorisation(id_notification){
        var type = "${type}";
        Swal.fire({
            title: '<spring:message code="label.Modifier"/> ',
            text: "<spring:message code="label.modifierautorisation"/> ",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "/api/updateStatut/"+id_notification+"/"+48+"/"+type,
                    type: "GET",
                    data: {},
                    success: function (response) {
                        var classif = ${classification};
                        if(type!=="ZF"){
                            window.location.href="/api/getListeAutorisation/"+type+"/0/40/0";
                        }
                        else{
                            window.location.href="/api/getListeAutorisationZF/"+type+"/0/40/0/"+classif;
                        }
                    },
