                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-12 mt-4">
                             ...
                             <%--   <div class="row justify-content-center mt-4">
                                ...
                                <c:if test="${inst.type.equals('3')}"><h3 class="mt-4"> <spring:message code="label.Lepetitionnaireaselectionnetouslescodes"/></h3></c:if>
                                <c:if test="${inst.type.equals('1')  || inst.type.equals('3')}">
                                        ...
                                        <div class="row  justify-content-center mb-4" style="margin:14px;">
                                            <button  class="btn btn-primary btn-lg mx-2 col-5" onclick="Changertype('${inst.type}')" ><spring:message code="label.Enregistrer"/>  </button>
                                        </div>
                                </c:if>
...
<script>
    ...
    function Changertype(val){
        if(val==="1"){
            var tr = $('#my_rows tfoot tr').length;

            if(tr===0){
                Swal.fire({
                    title: '<spring:message code="label.Avertissement"/>',
                    text: "<spring:message code="label.Selectionnezaumoinsuncode"/>",
            ...
            var check = $('#my_rows td button .fa-plus');
