    ...
    <div class="col-12">
        <nav aria-label="breadcrumb ml-4" dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}" >
            <ol class="breadcrumb ml-4">
                ...
                <li class="breadcrumb-item active" style="${pageContext.response.locale!='ar'?'':'margin-right:4rem !important'}" aria-current="page"><a href="/api/getListeInstallation/0/40/0"><spring:message code="label.Installationdetraitementdesdechets"/></a></li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="col-md-10 col-sm-12">
        <div class="row p-0 mb-2">
            <div class="col-md-auto col-sm-6 m-1">
                <a href="/api/getListeInstallation/0/40/0" class="btn btn-primary btn-block"><i class="${pageContext.response.locale=='ar'?'fa fa-arrow-right':'fa fa-arrow-left'} ml-2"></i><spring:message code="label.Retour"/></a>
            </div>
            <div class="col-md-auto col-sm-6 m-1">
                ...
                <c:if test="${inst.statut.id_statut_projet == 14 || inst.statut.id_statut_projet == 88 }">
                    <div class="col-md-auto col-sm-6 m-1">
