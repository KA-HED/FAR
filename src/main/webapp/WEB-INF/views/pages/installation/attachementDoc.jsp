                   ...
                   <input name="result" type="hidden">
                    <div class="card">
                        ...
                        <div class="row  mb-4" style="margin:14px;">
                            ...
                            <a class="btn btn-secondary btn-block"  href="/api/getListeInstallation/0/40/0" style="background: #f95f5f;"> <spring:message code='label.Annuler'/></a>
                        </div>
                    </div>
                </form>
            </div>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-10 mt-4">
                                ...
                                <div class="row  justify-content-center mb-4" style="margin:14px;">
                                    <a  class="btn btn-primary btn-lg mx-2 col-5" href="/api/getListeInstallation/0/40/0" ><spring:message code="label.Enregistrer"/>  </a>
                                    <a class="btn btn-secondary btn-lg col-5"  href="/api/getListeInstallation/0/40/0" style="background: #f95f5f;"> <spring:message code="label.Annuler"/></a>
                                </div>
                            </div>
                        </div>
                    </div>
