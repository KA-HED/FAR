        ...
        <div class="row justify-content-center p-5">
            ...
            <nav aria-label="breadcrumb col-10">
                <ol class="breadcrumb ml-4">
                    ...
                    <li class="breadcrumb-item" style="${pageContext.response.locale=='ar'?'margin-right:4rem !important':''}"><a href="/api/getListeInstallation/0/40/0"><spring:message code="label.InstalationDetraitementdesDechets"/></a></li>
    ...
    function addEtatInstallation(id,etat){
        ...
        if (test) {
            ...
            $.ajax ({
                ...
                success: function (response) {
                    window.location = "/api/recap_installation/"+id;
                },
                error: function (response) {
                    alert (' ajout non effectué');
                }
